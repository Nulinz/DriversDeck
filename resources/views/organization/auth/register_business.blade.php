        ...
        <div class="container">
            <div class="row justify-content-center align-items-center">
                ...
                <div class="col-md-6 mb-4 mb-md-0">
                    ...
                    <p class="text-muted fs-5">Step 4</p>
                ...
                <div class="col-md-6">
                    <div class="form-section">
                        <h3 class="text-center mb-4">Business Details</h3>
                        @if ($errors->any())
                                ...
                                @endif
                        <form action="{{ route('auth.register_business_store') }}"
        method="POST" enctype="multipart/form-data" id="form_input">
    @csrf

    <div class="mb-3">
        <label class="form-label fw-bold">PAN Number</label>
        <input type="text" class="form-control form-control-lg border-2" name="pan" value="{{ old('pan') }}"
            placeholder="Enter your PAN number" maxlength="10" minlength="10"
            oninput="this.value = this.value.replace(/[^A-Z0-9]/g, '')">
    </div>

    <div class="mb-3">
        <label class="form-label fw-bold">GST Number</label>
        <input type="text" class="form-control form-control-lg border-2" name="gst" value="{{ old('gst') }}"
            placeholder="Enter your GST number" maxlength="15" minlength="15"
            oninput="this.value = this.value.toUpperCase().replace(/[^A-Z0-9]/g, '')">
    </div>

    <div class="mb-3">
        <label class="form-label fw-bold">LOGO</label>
        <input type="file" class="form-control form-control-lg border-2" name="logo" accept="image/*">
        @error('logo')
