...
<body class="">
        ...
        <div class="row w-100 h-100">
            ...
            <div class="col-md-6 col-sm-12 d-flex align-items-center justify-content-center bg-white mt-n5">
                <div class="w-50 w-sm-100">
                    ...
                    {{-- <form class="" action="{{ route('auth.login_check') }}" method="POST">
                        @csrf
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control form-control-lg border-2" maxlength="10"
                                minlength="10" name="mobile" oninput="this.value = this.value.replace(/[^0-9]/g, '')">
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="d-flex justify-content-between align-items-center mb-3">
                            ...
                            <a href="{{ route('auth.register_details') }}" class="text-decoration-none">Register</a>
                        </div>
  ...
  <h2 class="text-center mb-3">Sign In</h2>
    <div class="mb-3">
        <label class="form-label fw-bold fs-4">Mobile Number</label>
        <input type="text" class="form-control form-control-lg border-2" name="mobile"
            maxlength="10" minlength="10" required
            oninput="this.value = this.value.replace(/[^0-9]/g, '')">
    </div>

    @if ($errors->has('mobile'))
        <div class="text-danger">{{ $errors->first('mobile') }}</div> @endif
    ...
    {{-- <a href="{{ route('auth.forgot_pass') }}" class="text-decoration-none">Forgot
                                Password?</a> --}}
    </div>

    <button type="submit" class="btn btn-primary btn-lg w-100 fs-4">Send OTP</button>
    </form>
