    ...
    <div class="row h-100">
      ...
      <div class="col-md-6 col-sm-12 d-flex align-items-center justify-content-center bg-white">
        <div class="w-50 w-sm-100">
          ...
          <form method="#" class="" action="{{ route('organization.auth.otp') }}">
            ...
            <p class="fs-4 mt-4 text-center">Back to <a href="{{ route('organization.auth.login') }}" class="text-decoration-none">Sign In</a></p>
        </div>
      </div>
    </div>
  </div>
