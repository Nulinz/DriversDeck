            ...
            <div class="row justify-content-center align-items-center">
                ...
                <div class="col-md-6">
                    <div class="form-section">
                        ...
                        <form action="{{ route('auth.register_asset_store') }}" method="POST" id="form_input">
                            @csrf

                            <div class="mb-3">
                                <label class="form-label fw-bold">Number of Vehicle</label>
                                <input type="text" class="form-control form-control-lg border-2" name="no_vehicle"
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control form-control-lg border-2" name="no_drivers"
                                    placeholder="Enter number of drivers working"
                                    oninput="this.value = this.value.replace(/[^0-9]/g, '')">
                            </div>

                            <div class="mb-3">
                                <label class="form-label fw-bold">No of Vacancies</label>
                                <input type="text" class="form-control form-control-lg border-2" name="no_vacancies"
                                    placeholder="Enter number of vacancies"
                                    oninput="this.value = this.value.replace(/[^0-9]/g, '')">
                            </div>

                            <button type="submit"
                                class="btn btn-primary btn-lg fw-bold fs-4 w-100 py-2 form_btn">Submit</button>
                        </form>
