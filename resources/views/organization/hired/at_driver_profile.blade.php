        ...
        <div class="container-fluid p-0">
            <div class="row mb-2 mb-xl-3">
                <div class="col-auto d-none d-sm-block">
                    <h3><strong>Driver Profile</strong></h3>
                </div>
            </div>
            ...
            <div class="row">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="d-flex align-items-center justify-content-start">
                                <img class="profile_img" src="{{ asset($driver->img ?? '/assets/images/avatar.png') }}"
                                    alt="Avatar">
                            ...
                            <div class="d-flex align-items-center justify-content-between mb-3">
                                ...
                                <p class="text-dark mb-0">{{ $driver->c_city }}</p>
                            </div>
                            <div class="d-flex align-items-center justify-content-between">
                                <h6 class="text-muted mb-0 fw-bold">State</h6>
                                <p class="text-dark mb-0">{{ $driver->c_state }}</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-7 col-xl-8">
                    <div class="nav nav-tabs d-flex justify-content-start align-items-center gap-x-4 gap-xl-4 mb-3"
                        ...
                        <a class="" data-bs-toggle="list" href="#Experience" role="tab" aria-selected="false"
                            tabindex="-1">
                            Experience
                        </a>
                        {{-- <a class="" data-bs-toggle="list" href="#Trips" href="#" role="tab"
                        ...
                        <a class="" data-bs-toggle="list" href="#Feedback" role="tab" aria-selected="false"
                            tabindex="-1">
                            Feedback
                        </a>
                    </div>
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-3 mb-3">
                                            ...
                                            <p class="fs-6 text-dark mb-0">lorem</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card mb-3">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-3 mb-3">
                                            <h5 class="fs-6 text-muted mb-2 fw-bold">Aadher Number</h5>
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-3 mb-3">
                                            ...
                                            <p class="fs-6 text-dark mb-0">{{ $driver->rel_date }}</p>
                                        </div>
                                        <div class="col-md-3 mb-3">
                                        ...
                                        <tbody class="">
                                            @foreach ($feed as $fd)
                                                <tr>
                                                    ...
                                                    <td>
                                                        @php
                                                            $rating = round($fd->rating); // Round off rating to nearest integer
                                                        @endphp
                                                        ...
                                                        @for ($i = 1; $i <= 5; $i++)
                                                            @if ($i <= $rating)
                                                                <!-- Filled star -->
                                                                <i
                                                                    class="text-warning align-middle me-1 fs-5 fa fa-fw fa-star"></i>
                                                            @else
                                                                <!-- Empty star -->
                                                                <i
                                                                    class="text-secondary align-middle me-1 fs-5 fa fa-fw fa-star"></i>
                                                            @endif
                                                        @endfor
                                                    </td>
                                                    <td>{{ $fd->remarks }}</td>
                                                    <td>{{ Carbon\Carbon::parse($fd->created_at)->format('d-m-Y') }}</td>
                                                </tr>
                                            @endforeach
                                        </tbody>
                                    </table>
